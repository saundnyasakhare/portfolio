...
export const countersAnimation = () => {
    ...
    // counters
    const number = document.querySelectorAll('.saundyacounter');
    ...
    // progressbar type 1
    const progGo = document.querySelectorAll(".saundyacircular-progress");
    ...
    // progressbars type 2
    const width = document.querySelectorAll(".saundyabar");
